...
const DateService = {
  ...
  getTomorrowString: (format = "dd-mm-yyyy") => {
    let d = new Date();
  ...
  getAfterDays: (days) => {
    try {
      ...
      let day = DateService.preZero(date.getDate());

      let month = DateService.preZero(date.getMonth() + 1);
  ...
  // getAfterDays: (dateString, days) => {
  //   try {
  //     let date = new Date(dateString);
  //     // console.log("Date created is -------", date);
  //     let day =
  //       date.getDate() > 9
  //         ? Number(date.getDate() + days)
  //         : "0" + Number(date.getDate() + days);
  //     let month =
  //       date.getMonth() + 1 > 9
  //         ? date.getMonth() + 1
  //         : "0" + (date.getMonth() + 1);
